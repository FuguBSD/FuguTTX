...
less, through llama.cpp. The model and the harness together make the TTX
agent. The `ttx` harness — Perl 5, base modules only — operates the model in
the boundaries of pledge, unveil, doas rules, and dry-run gates.
