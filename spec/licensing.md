...
| ---------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Weights                                        | **Apache 2.0**                                                         | Inherited cleanly from the base model ([base model](model.md)). Policy excludes a base that forces a restrictive derivative license — for TTX 1 and for each variant. |
