...
`github.com/openbsd/{src,ports,www,xenocara}`. The documented fallback is the Game of
Trees Hub mirror: `ssh://anonymous@openbsd.gothub.org/{src,ports,www,xenocara}.git`, at
most one commit behind CVS. Do not pull from CVS directly.
