...
The specification is not frozen. It must agree with the project at all times. Apply these rules:

- When your change alters a design, an interface, or a procedure, update the specification in the same change.
- When the specification is wrong or not complete, correct the specification. Do not work around it, and do not let code and specification drift apart.
- When your change goes against a decision, stop. Propose a change to [decisions](spec/decisions.md) and get human approval first.
